...
import style from './StaffManage.less';
...
function StaffManage({ dispatch, staffManage }) {
    ...
    return(
        <div style={{ width : '100%' , overflow : 'auto' , display : 'flex' , flexWrap : 'nowrap' , height : 'calc(100% - 50px)' }}>
            <div style={{ width : '330px' }}>
                <StaffManageLeftList {...staffManageListProps}/>
            </div>
            <div style={{ width : 'calc(100% - 330px)', padding : '10px 20px 20px 20px' , minWidth : 1100 }}>
                <div className="tabs">
                    <div className='zj_tabs_staff_manage_switch'>
