...
function ScrmOverView ({ dispatch , scrmOverView }){
        ...
        let CheckMoreCase = function(){
            dispatch({
                ...
                payload:{
                    ...
                    orgSucPageIndex : orgSucPageIndex+1,            //机构使用案例页码
                }
            });
            dispatch({
        ...
        let CheckMoreScrmMessage = function(){
            dispatch({
                ...
                payload:{
                    ...
                    scrmMessagePageIndex : scrmMessagePageIndex+1,      //营销资讯页码
                }
            });
            dispatch({
                ...
                payload:{
                    pageSize : 5,
                    pageIndex : scrmMessagePageIndex+1,
                }
            });
        }
	...
	return (
        <div style={{ backgroundColor : '#e9e9ed', padding : 10 , borderRadius : 10 , minWidth : 1350 }} id='zj_scrm_overview'>
