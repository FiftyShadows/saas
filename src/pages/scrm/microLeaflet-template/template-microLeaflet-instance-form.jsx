				...
				detailData : [
					{
						...
						code_imgUrl : 'https://img.ishanshan.com/gimg/img/576d7daaa1acd5dda2381433918e9287',
						contact : [
						...
						img_intro : [
							{ imgurl : 'https://img.ishanshan.com/gimg/img/da2a105668fb6e21ceae6fc46b17ff20' },
							{ imgurl : 'https://img.ishanshan.com/gimg/img/b4d3eba5a8a8df3f5789482029d8645d' }
						],
						course_intro : [
				...
				detailData : [
					{
						...
						orgImgs :   [
							{ imgurl : 'https://img.ishanshan.com/gimg/img/10270322c277cb47ce1f33ef368e06c2' },
						...
						codeImgUrl  : 'https://img.ishanshan.com/gimg/img/576d7daaa1acd5dda2381433918e9287',
						remark      : '扫码关注我们哦'
					}
				]
			})
				...
				detailData : [
					{
						...
						seqNo : 2,
						title : '邀请词',
						content : '尊敬的联系人朋友们：\n为了培养孩子们的学习兴趣，给孩子们搭建一个展示自我、互相交流学习的平台，同时帮助联系人朋友们了解艺术学习的特殊性，我们本周将组织一场幼儿钢琴比赛，诚邀对钢琴班感兴趣的联系人参与。\n因幼儿年龄较小均为初学者，所以请各位联系人一定多给孩子鼓励，让宝贝自信地展示表演。'
					},{
						type  : 'Page3Component',
						seqNo : 3,
						title : '注意事项',
				...
				detailData : [
					{
						...
						qrImgUrl  : 'https://img.ishanshan.com/gimg/img/8fdff2f6c3325b779aa59fc664be08e0',
						remark      : '长按二维码关注我们哦!',
				...
				detailData : [
					{
						...
						p7Remark      	: '也可以扫码关注我们哦',
						p7CodeImgUrl  	: 'https://img.ishanshan.com/gimg/img/576d7daaa1acd5dda2381433918e9287',
					}
				]
			})
		}else if( activityTypeId == 109 ){
				...
				detailData : [
					{
						...
						qrUrl 	: 'https://img.ishanshan.com/gimg/img/576d7daaa1acd5dda2381433918e9287',
					},{
						type   : 'Page6Component',
						seqNo  : 6,
						title  : '联系我们' ,
