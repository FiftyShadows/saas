                    ...
                    <div className="config-item">
                        <div className="config-item-gift">
                            ...
                            <div className="config-item-gift-content">
                                <Input type="textarea" placeholder="请输入礼品信息,小礼物能有效提升联系人预约到店率(礼物由商家自行提供)" defaultValue={this.state.giftContent} autosize={{ minRows: 3, maxRows: 6 }} ref="reservation_config_gift_content" />
                            </div>
                            : ''}
                        </div>
                    </div>
