...
export async function deleteClassPackage(params) {
  return requestData(`${BASE_URL}/productController/deleteProduct`, {
    method: 'post',
    headers: {
        "Content-Type": "application/x-www-form-urlencoded",
    },
...
export async function getClassPackageInfo(params) {
  return requestData(`${BASE_URL}/productController/getSingleProduct`, {
    method: 'post',
    headers: {
        "Content-Type": "application/x-www-form-urlencoded",
    },
...
export async function confirmAddClassPackage(params) {
  return requestData(`${BASE_URL}/productController/createProduct`, {
    method: 'post',
    headers: {
        "Content-Type": "application/x-www-form-urlencoded",
    },
