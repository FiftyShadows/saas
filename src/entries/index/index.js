...
window.BASE_URL = window.BASE_URL||'/crm';
...
app.model(require('../../models/index/crm/parent-manage/parentManageModel'));                                       //联系人管理
app.model(require('../../models/index/crm/parent-manage/parentManageDetailModel'));                                 //联系人管理详情
...
app.model(require('../../models/index/crm/contract-order/contractOrderReceiptListModel'));                          //CRM 合同收款列表
...
/***********************************工单*************************************************************************************************/
app.model(require('../../models/index/work-order/WorkOrder'));                                                      //工单

/***********************************早教类erp*********************************************************************************************/
app.model(require('../../models/index/cerp/cerp-overview/Overview'));                                                //教学2-首页
app.model(require('../../models/index/cerp/courseManage/courseManageModel'));                                        //教学2-课程管理
...
app.model(require('../../models/index/system/StaffManage'));                                                         //员工管理
...
app.model(require('../../models/index/system/payment-center/account-details/AccountDetailsModel'));                  //支付中心>账户明细
...
app.model(require('../../models/index/system/message/messageModel'));                                                //短信业务列表
