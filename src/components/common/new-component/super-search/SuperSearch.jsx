...
import { Icon, Form, Input, Select, DatePicker, Button, message, TimePicker , Cascader } from 'antd';
            ...
            formItems.push(
				...
				>
					{ getFieldDecorator( key, {
						...
						<Cascader placeholder='请选择所在地址' options = { ChinaDivision } changeOnSelect size='default' { ...options }/>
					)}
				</FormItem>
			)
        }
