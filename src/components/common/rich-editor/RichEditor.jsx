...
var RichEditor = React.createClass({
    ...
    componentDidMount(){
        ...
        let editor = UE.getEditor(this.props.UEId, {
        ...
        editor.ready( function( ueditor ) {
            let value = me.state.html?me.props.value:'<p></p>';
    ...
    render() {
        return (
            <div className="common_rich_editor_cont">
                <script id={this.props.UEId} name="content" type="text/plain"></script>
            </div>
        )
    }
})
