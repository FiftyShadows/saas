...
import ParentComment from './parent-comment/ParentComment';                                     //联系人评价
...
function DetailModal({
    ...
    detailModalMsg,                         //详情需要渲染的数据(列表中当前项的数据，详情头部和上课内容tab页的数据从此取，老师评价和联系人评价数据从接口中取)
    ...
    /*联系人评价tab页*/
    parentCommentLoading,                   //联系人评价tab页是否是加载状态
    parentCommentMsg,                       //联系人评价列表数据
