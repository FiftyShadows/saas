...
function MicroModuleFormComponent ({
    ...
    updateItem,
    changeShareConfig,
    changeModuleName, changeModuleMusic,
    ...
    let bar_props = {
        activityBarKey,changeBarKey, orgId, orgName, formPageKey, updateItem, resetModuleMusic, resetShareImage, moduleMusicInit,
    }
    ...
    return (
        <PageModal
           ...
           onClose={handleClose}
           footer={[
                <Popconfirm title="确定要保存吗?" onConfirm={handleOnSubmit} >
                    <Button type="primary" loading={loading} >提交</Button>
                </Popconfirm>,
                <Popconfirm title="确定要关闭窗口吗?" onConfirm={handleClose} >
