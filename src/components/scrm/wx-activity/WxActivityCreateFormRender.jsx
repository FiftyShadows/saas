                    ...
                    <div className = 'success' >
                        ...
                        <ul className = 'applyedUser'>
                            <li className = 'applyedUser_item' >
                                <img className = 'applyedUser_item_img' src = 'https://img.ishanshan.com/gimg/img/300f433150bdfe4c13fa0e137efce725' />
                                <div style = {{ textAlign : 'center' }} >宝宝</div>
                            </li>
                            <li className = 'applyedUser_item' >
                                <img className = 'applyedUser_item_img' src = 'https://img.ishanshan.com/gimg/img/85148fc80751d0efcf809ddab826ca11' />
                                <div style = {{ textAlign : 'center' }} >宝宝</div>
                            </li>
                            <li className = 'applyedUser_item' >
                                <img className = 'applyedUser_item_img' src = 'https://img.ishanshan.com/gimg/img/300f433150bdfe4c13fa0e137efce725' />
