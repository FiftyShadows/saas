                    ...
                    <Select
                        ...
                        {/*{*/}
                            {/*parentarr && parentarr!= null &&  parentarr!= undefined  ? parentarr.map(function (item) {*/}
                                    {/*<Option value = { item.parentId }>{ item.parentName + '（联系人姓名）' }</Option>*/}
                                {/*}):null*/}
                        {/*}*/}
...

                        {
                            parentarr  && parentarr .map(function( item, index ){
                                return ( <Option key = { 'intention_' + item.parentId } value = { item.parentId } >{ item.parentName + '（联系人姓名）'}</Option> )
                            })
                        }
