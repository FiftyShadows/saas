...
//						initialValue : studentInfo.orgId || '',
                ...
                <div className={style.info_cont}>
                    <div className={style.info_text}>分配客户时，以下信息也会同时交接</div>
                    <Checkbox checked={true} className={style.info_check}>客户联系人</Checkbox>
                    <Checkbox checked={true} className={style.info_check}>客户退款单</Checkbox>
                </div>
            </Form>
        </Modal>
    )
