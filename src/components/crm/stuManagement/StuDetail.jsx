  ...
  //报班信息
   ...
   let VisitplanTabProp= {
    ...
    let expect = [
        ...
        { label : '售后客服', value : 'counselorName' }
	];
    ...
    return(
        <NewModal {...StuDetailProps}>
            ...
            <Tabs onChange = { StuDetailModalTabChange } size = "small"  className={styles.studetail_message} activeKey = { changeTableTab } >
                <TabPane tab="客户详情" key="StuDetailTab">  <StudetailTab {...StudetailTabProps}/> </TabPane>
                ...
                */}
                ...
                <TabPane tab={<span>联系人<span style={{color:'#5d9cec',fontSize:'12px'}}></span></span>} key="ParentTab">
