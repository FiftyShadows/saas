                ...
                <div className={styles.leads_detail_message_top}>
                    ...
                    <div className={styles.leads_detail_message_top_right}>
                        ...
                        <ButtonGroup style = {{ marginRight : 20 , color : '#5d9cec' }} >
                            <Button className={styles.radio_button_group} style = {{ width : 100 }} onClick = {() => LeadsFollowDetailMoreMenuChoose('transform_stu',leadsFollowDetailLeadMessage)}>转为付费客户</Button>
