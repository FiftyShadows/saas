...
const StuMergeModal = ({
    ...
    function Title(){
        return(
            <div>付费客户列表（{leadsFollowDetailLeadMessage.orgName}）</div>
        );
    }
            ...
            <Modal {...modalOpts}>
                <Form>
                        ...
                        <div>
                            ...
                            <div className={styles.parent_intro}>
                                { leadsFollowStuMergeModalParent.length > 1 ?
                                    <div>线索里的联系人信息已存在，请选择合并联系人</div>
                                    :
                                  leadsFollowStuMergeModalParent.length == 1 ?
                                    <div>系统将自动把线索合并至已有联系人(1个联系人)</div>
                                    :
                            ...
                            >
                                {getFieldDecorator('parentId', {
                                    ...
                                    rules: [
                                        { required: true, message: '请选择线索联系人' },
                                    ],
                                })(
                                    <RadioGroup>
                                ...
                                <div>
                                    ...
                                    >
                                        {getFieldDecorator('parents', {
                                            ...
                                            rules: [
                                                { required: true, message: '请选择已有联系人' },
                                            ],
                                        })(
                                            <RadioGroup>
                                                { parent || [] }
                    ...
                    <div className={styles.stu_intro}>
                        <div>线索付费客户：{leadsFollowDetailLeadMessage.name}</div>
                        <div>
                            <a onClick={() => StuMergeOpenCrmStuTable()}>{ stuClueCrmStuWetherFirstChangeMergeStu == 0 ? '合并已有付费客户（可选）' : '更换合并付费客户' }
                            </a>&nbsp;
                    ...
                    {<QueueAnim
                        ...
                        {leadsFollowCrmStuModalSelectedRow.length == 1 ?
                            <div className={styles.choosed_crm_stu} key='choosed_crm_stu'>
                                <div>已有付费客户：{leadsFollowCrmStuModalSelectedRow[0].name}</div>
                                <div>线索学员将合并至已有付费客户</div>
                            </div>
                            :
                            null
                        }
