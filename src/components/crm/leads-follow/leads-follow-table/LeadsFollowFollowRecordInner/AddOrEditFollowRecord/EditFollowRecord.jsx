...
function EditFollowRecord({
    ...
    console.info('leadsFollowDetailLeadMessage',leadsFollowDetailLeadMessage)
            ...
            <Form>
                ...
                >
                    { getFieldDecorator('parentId', {
                        ...
                        <Select disabled = { true } placeholder = '请选择跟进联系人' size = 'default'>
                ...
                >
                    { getFieldDecorator('type', {
                        initialValue : key || undefined,//leadsFollowFollowRecordEditContent.type || undefined,
                        rules : [
