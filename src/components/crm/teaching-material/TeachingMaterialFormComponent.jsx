...
function TeachingMaterialFormComponent ({
    ...
    return (
        <Modal
            ...
            title={(formDataId == undefined || formDataId == '') ? '新增增值服务' : '编辑增值服务'}
            visible = { visible }
            maskClosable = { false }
            closable = { true }
            width = { 550 }
           ...
           <div className={styles.teaching_material_form_cont}>
               <Form>
                    ...
                    {getFieldDecorator('name', {
                        ...
                        <Input placeholder="请输入服务名称" size='default'/>
                      )}
                    </FormItem>
                    <FormItem
                          {...formItemLayout}
                    ...
                    {getFieldDecorator('describes', {
                        ...
                        <Input type="textarea" placeholder="请输入服务描述" autosize={{ minRows: 3, maxRows: 4 }}/>
                      )}
                    </FormItem>
                    <FormItem
                        {...formItemLayout}
                    ...
                    >
                        {getFieldDecorator('unit', {
                            initialValue: formData && formData.unit || undefined,
                            rules: [{
                    ...
                    >
                        {getFieldDecorator('status', {
                            initialValue: formData && formData.status || undefined,
                            rules: [{
