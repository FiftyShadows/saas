...
export default {
  ...
  effects: {
    *handleShow({ payload }, { call, put }) {
        ...
        let moduleConfigData = {}, currentPageKey = '', currentPageConfig = {}, activeItemKey = '', moduleCode = '', moduleMusicInit = {}, moduleShareInit = {};
        ...
        yield put({
            ...
            payload: {
                visible: true,
                loading: false,
                orgId,orgName,moduleId,moduleInstId,moduleCode,
